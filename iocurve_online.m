function varargout = iocurve_online(varargin)
% IOCURVE_ONLINE MATLAB code for iocurve_online.fig
%      IOCURVE_ONLINE, by itself, creates a new IOCURVE_ONLINE or raises the existing
%      singleton*.
%
%      H = IOCURVE_ONLINE returns the handle to a new IOCURVE_ONLINE or the handle to
%      the existing singleton*.
%
%      IOCURVE_ONLINE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IOCURVE_ONLINE.M with the given input arguments.
%
%      IOCURVE_ONLINE('Property','Value',...) creates a new IOCURVE_ONLINE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before iocurve_online_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to iocurve_online_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @iocurve_online_OpeningFcn, ...
    'gui_OutputFcn',  @iocurve_online_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before iocurve_online is made visible.
function iocurve_online_OpeningFcn(hObject, eventdata, handles, varargin)
...
dc = {'2.5','5','7.5','10','12.5','15','17.5','20','22.5','25','27.5','30','32.5','35','37.5','40','42.5','45','47.5','50','55','60','65','70','75','80','85',...
...
function varargout = iocurve_online_OutputFcn(hObject, eventdata, handles)
